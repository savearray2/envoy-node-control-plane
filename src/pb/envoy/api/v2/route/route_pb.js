...
goog.exportSymbol('proto.envoy.api.v2.route.RouteAction.RetryPolicy', null, global);
goog.exportSymbol('proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate', null, global);
goog.exportSymbol('proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority', null, global);
...
proto.envoy.api.v2.route.CorsPolicy = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.envoy.api.v2.route.CorsPolicy.repeatedFields_, null);
};
...
proto.envoy.api.v2.route.RouteAction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    retryPolicy: (f = msg.getRetryPolicy()) && proto.envoy.api.v2.route.RouteAction.RetryPolicy.toObject(includeInstance, f),
...
proto.envoy.api.v2.route.RouteAction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 24:
      ...
      break;
    case 9:
      var value = new proto.envoy.api.v2.route.RouteAction.RetryPolicy;
      reader.readMessage(value,proto.envoy.api.v2.route.RouteAction.RetryPolicy.deserializeBinaryFromReader);
...
proto.envoy.api.v2.route.RouteAction.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.envoy.api.v2.route.RouteAction.RetryPolicy.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.envoy.api.v2.route.RouteAction.RetryPolicy.repeatedFields_, null);
};
goog.inherits(proto.envoy.api.v2.route.RouteAction.RetryPolicy, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.envoy.api.v2.route.RouteAction.RetryPolicy.displayName = 'proto.envoy.api.v2.route.RouteAction.RetryPolicy';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.repeatedFields_ = [5,7];
 ...
 * @return {!Object}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.api.v2.route.RouteAction.RetryPolicy.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    retryPriority: (f = msg.getRetryPriority()) && proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.toObject(includeInstance, f),
    retryHostPredicateList: jspb.Message.toObjectList(msg.getRetryHostPredicateList(),
    proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.api.v2.route.RouteAction.RetryPolicy;
  return proto.envoy.api.v2.route.RouteAction.RetryPolicy.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority;
      reader.readMessage(value,proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.deserializeBinaryFromReader);
      msg.setRetryPriority(value);
      break;
    case 5:
      var value = new proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate;
      reader.readMessage(value,proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.api.v2.route.RouteAction.RetryPolicy.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.oneofGroups_);
};
goog.inherits(proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.displayName = 'proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority';
}
/**
 * Oneof group definitions for this message. Each group defines the field
 * numbers belonging to that group. When of these fields' value is set, all
 ...
 * @const
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.oneofGroups_ = [[2,3]];

/**
 * @enum {number}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.ConfigTypeCase = {
...
/**
 * @return {proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.ConfigTypeCase}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.getConfigTypeCase = function() {
  return /** @type {proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.ConfigTypeCase} */(jspb.Message.computeOneofCase(this, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority;
  return proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.setName = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.getConfig = function() {
...
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.setConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.oneofGroups_[0], value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.clearConfig = function() {
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.hasConfig = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.getTypedConfig = function() {
...
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.setTypedConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.oneofGroups_[0], value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.clearTypedConfig = function() {
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority.prototype.hasTypedConfig = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @constructor
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.oneofGroups_);
};
goog.inherits(proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.displayName = 'proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate';
}
/**
 * Oneof group definitions for this message. Each group defines the field
 * numbers belonging to that group. When of these fields' value is set, all
 ...
 * @const
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.oneofGroups_ = [[2,3]];

/**
 * @enum {number}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.ConfigTypeCase = {
  CONFIG_TYPE_NOT_SET: 0,
  CONFIG: 2,
  TYPED_CONFIG: 3
};
...
/**
 * @return {proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.ConfigTypeCase}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.getConfigTypeCase = function() {
  return /** @type {proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.ConfigTypeCase} */(jspb.Message.computeOneofCase(this, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    config: (f = msg.getConfig()) && google_protobuf_struct_pb.Struct.toObject(includeInstance, f),
    typedConfig: (f = msg.getTypedConfig()) && google_protobuf_any_pb.Any.toObject(includeInstance, f)
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate;
  return proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.setName = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {?proto.google.protobuf.Struct}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.getConfig = function() {
  return /** @type{?proto.google.protobuf.Struct} */ (
    jspb.Message.getWrapperField(this, google_protobuf_struct_pb.Struct, 2));
};
...
/** @param {?proto.google.protobuf.Struct|undefined} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.setConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.oneofGroups_[0], value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.clearConfig = function() {
  this.setConfig(undefined);
};
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.hasConfig = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {?proto.google.protobuf.Any}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.getTypedConfig = function() {
  return /** @type{?proto.google.protobuf.Any} */ (
    jspb.Message.getWrapperField(this, google_protobuf_any_pb.Any, 3));
};
...
/** @param {?proto.google.protobuf.Any|undefined} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.setTypedConfig = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.oneofGroups_[0], value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.clearTypedConfig = function() {
  this.setTypedConfig(undefined);
};
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate.prototype.hasTypedConfig = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {string}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getRetryOn = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setRetryOn = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {?proto.google.protobuf.UInt32Value}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getNumRetries = function() {
  return /** @type{?proto.google.protobuf.UInt32Value} */ (
    jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.UInt32Value, 2));
};
...
/** @param {?proto.google.protobuf.UInt32Value|undefined} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setNumRetries = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.clearNumRetries = function() {
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.hasNumRetries = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getPerTryTimeout = function() {
...
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setPerTryTimeout = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.clearPerTryTimeout = function() {
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.hasPerTryTimeout = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {?proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getRetryPriority = function() {
  return /** @type{?proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority, 4));
};


/** @param {?proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryPriority|undefined} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setRetryPriority = function(value) {
  jspb.Message.setWrapperField(this, 4, value);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.clearRetryPriority = function() {
 ...
 * @return {!boolean}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.hasRetryPriority = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {!Array.<!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate>}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getRetryHostPredicateList = function() {
  return /** @type{!Array.<!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate, 5));
};


/** @param {!Array.<!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate>} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setRetryHostPredicateList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 5, value);
};


/**
 * @param {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate=} opt_value
 * @param {number=} opt_index
 * @return {!proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.addRetryHostPredicate = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.envoy.api.v2.route.RouteAction.RetryPolicy.RetryHostPredicate, opt_index);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.clearRetryHostPredicateList = function() {
 ...
 * @return {number}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getHostSelectionRetryMaxAttempts = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/** @param {number} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setHostSelectionRetryMaxAttempts = function(value) {
  jspb.Message.setField(this, 6, value);
};
 ...
 * @return {!Array.<number>}
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.getRetriableStatusCodesList = function() {
  return /** @type {!Array.<number>} */ (jspb.Message.getRepeatedField(this, 7));
};


/** @param {!Array.<number>} value */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.setRetriableStatusCodesList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.addRetriableStatusCodes = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 7, value, opt_index);
};


proto.envoy.api.v2.route.RouteAction.RetryPolicy.prototype.clearRetriableStatusCodesList = function() {
...
proto.envoy.api.v2.route.RouteAction.prototype.getRetryPolicy = function() {
  return /** @type{?proto.envoy.api.v2.route.RouteAction.RetryPolicy} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.route.RouteAction.RetryPolicy, 9));
};


/** @param {?proto.envoy.api.v2.route.RouteAction.RetryPolicy|undefined} value */
